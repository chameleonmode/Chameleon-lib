...
public enum MBoxButtons { Ok, OkCancel, YesNo, YesNoCancel, RetryCancel, Close }
public enum TaskDialogResult { None, Command, CustomButton, CheckBox, OK, Cancel, Yes, No, Retry, Close }
public enum Symbas {
	Accept = 57611,
	Account = 57704,
	Add = 57609,
